...
[macro name=staffroll_asuha]
	[call storage="ed_1.ks" cond=!kag.skipNoDisp]
	[endmacro]

[macro name=staffroll_tukuyomi]
	[call storage="ed_2.ks" cond=!kag.skipNoDisp]
	[endmacro]

[macro name=staffroll_siina]
	[call storage="ed_3.ks" cond=!kag.skipNoDisp]
	[endmacro]

[macro name=staffroll_karin]
	[call storage="ed_4.ks" cond=!kag.skipNoDisp]
	[endmacro]

[macro name=staffroll_yumi]
	[call storage="ed_5.ks" cond=!kag.skipNoDisp]
	[endmacro]

[macro name=staffroll_siho]
	[call storage="ed_6.ks" cond=!kag.skipNoDisp]
	[endmacro]
	
[macro name=staffroll_inori]
	[call storage="ed_7.ks" cond=!kag.skipNoDisp]
	[endmacro]
...
[macro name="backto_title"]
[exit storage="start.ks" target=*title]
[endmacro]

[macro name="dummy_message"]
[initscene]
[emb exp=mp.text][r eol=true][r eol=true]
[msgoff]
[backto_title cond=mp.totitle]
[endmacro]
