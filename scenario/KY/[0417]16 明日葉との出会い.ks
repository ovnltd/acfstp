...
俺はドラム缶に右手をかざし、
ただ最適解の導きのまま、宙に[ruby text=ブライトネススクエア][ch text=光の四方形]を描いた。
...
今ここに“[ruby text=ブライトネススクエア][ch text=光の四方形]”が完成した！
...
[ruby text=ブライトネススクエア][ch text=光の四方形]は、シールドの役目を果たし、
爆風から俺たちを守ってくれる。
...
[seladd target=*声を掛ける text=『声を掛ける』]
